...
function ZGVFSectionDropDown_Initialize()
  if ZygorGuidesViewer then
    ZygorGuidesViewer:InitializeDropDown()
  end
end

function ZGVFSectionDropDown_Func()
  if ZygorGuidesViewer then
    ZygorGuidesViewer:SectionChange(this.value)
  end
...
function ZygorGuidesViewerFrame_HighlightCurrentStep()
  if ZygorGuidesViewer.CurrentStep then
    ZygorGuidesViewer:HighlightCurrentStep()
  end
end
