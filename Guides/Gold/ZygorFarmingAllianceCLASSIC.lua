...
ZygorGuidesViewer:RegisterGuide(
  'GOLD\\Farming\\Coyote Meat, Boar Intestines, Stringy Vulture Meat',
  {
    meta = { goldtype = 'route', levelreq = { 10, 60 } },
...
ZygorGuidesViewer:RegisterGuide(
  'GOLD\\Farming\\Goretusk Snout, Goretusk Liver',
  {
    meta = { goldtype = 'route', levelreq = { 10, 60 } },
    items = { { 731, 48 }, { 723, 52 } },
    maps = { 'Westfall' },
...
ZygorGuidesViewer:RegisterGuide(
  'GOLD\\Farming\\Crawler Meat, Crawler Meat',
  {
    meta = { goldtype = 'route', levelreq = { 10, 60 } },
...
ZygorGuidesViewer:RegisterGuide(
  'GOLD\\Farming\\Tough Condor Meat',
  {
...
ZygorGuidesViewer:RegisterGuide(
  'GOLD\\Farming\\Soft Frenzy Flesh',
  {
    meta = { goldtype = 'route', levelreq = { 10, 60 } },
    items = { { 5468, 60 } },
    maps = { 'Darkshore' },
